...
date: |
  "`r Sys.Date()`"  
  ![](./imagenes/etsiiaa.png){width=4in}
...
### Evolución de volumen de madera de calidad.
...
### Evolución de volumen total de madera.
...
## Caracterización de productos potenciales
