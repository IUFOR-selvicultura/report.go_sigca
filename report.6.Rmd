...
```{r plot.vol.gross M2, fig.height=5, fig.width=13, fig.align='center', fig.cap='Volumen total de madera de más de 20 cm en punta delgada, Régimen selvícola M2' }
...
```{r plot.vol.gross M4, fig.height=5, fig.width=13, fig.align='center', fig.cap='Volumen total de madera de más de 20 cm en punta delgada, Régimen selvícola M4'}
## gráficas volumen madera total por calidades y escenarios de gestión
...
```{r plot.vol.gross M8, fig.height=5, fig.width=13, fig.align='center', fig.cap='Volumen total de madera de más de 20 cm en punta delgada, Régimen selvícola M8'}
## gráficas volumen madera total por calidades y escenarios de gestión
ggplot(data = data.simul[data.simul$RegimenClara=='M8',],
       aes( x= Edad, y=VCC20,
           group = Calidad, colour = Calidad )) +
 va   geom_line() + facet_grid( ~ Zona) +
    labs( x = 'Edad (años)', y = 'Volumem (m^3^/ha)'## ,
         ## title = 'Volumen total de madera de más de 20 cm en punta delgada / Régimen selvícola M8'
         )
```

```{r plot.vol.gross MG2, fig.height=5, fig.width=13, fig.align='center', fig.cap='Volumen total de madera de más de 20 cm en punta delgada, Régimen selvícola MG2'}
## gráficas volumen madera total por calidades y escenarios de gestión
...
```{r plot.vol.total M2, fig.height=5, fig.width=13, fig.align='center', fig.cap='Volumen total de madera de más de 7 cm en punta delgada, Régimen selvícola M2'}
...
```{r plot.vol.total M4, fig.height=5, fig.width=13, fig.align='center', fig.cap='Volumen total de madera de más de 7 cm en punta delgada, Régimen selvícola M4'}
## gráficas volumen madera fina por calidades y escenarios de gestión
ggplot(data = data.simul[data.simul$RegimenClara=='M4',],
       aes( x= Edad, y=VCC7,
           group = Calidad, colour = Calidad )) +
...
```{r plot.vol.total M8, fig.height=5, fig.width=13, fig.align='center', fig.cap='Volumen total de madera de más de 7 cm en punta delgada, Régimen selvícola M8'}
## gráficas volumen madera fina por calidades y escenarios de gestión
ggplot(data = data.simul[data.simul$RegimenClara=='M8',],
       aes( x= Edad, y=VCC7,
           group = Calidad, colour = Calidad )) +
...
```{r plot.vol.total MG2, fig.height=5, fig.width=13, fig.align='center', fig.cap='Volumen total de madera de más de 7 cm en punta delgada, Régimen selvícola MG2'}
## gráficas volumen madera fina por calidades y escenarios de gestión
ggplot(data = data.simul[data.simul$RegimenClara=='MG2',],
       aes( x= Edad, y=VCC7,
           group = Calidad, colour = Calidad )) +
...
Es lo que se conoce como valor esperado del suelo (@DiazBalteiro1998).



El marco del análisis se centra en la comparación de una explotación forestal para la que se proponen distintas alternativas selvícolas. 
en contraposición al análisis de montes ordenados con rentas contínuas. 
...
df.M2.i.variables <- data.frame( "M2", edad.int, M2.i.variables.Esc1.VCC20, M2.i.variables.Esc1.VCC7, M2.i.variables.Esc2.VCC20, M2.i.variables.Esc2.VCC7)
...
df.M4.i.variables <- data.frame( "M4", edad.int, M4.i.variables.Esc1.VCC20, M4.i.variables.Esc1.VCC7, M4.i.variables.Esc2.VCC20, M4.i.variables.Esc2.VCC7)
...
df.M8.i.variables <- data.frame( "M8", edad.int, M8.i.variables.Esc1.VCC20, M8.i.variables.Esc1.VCC7, M8.i.variables.Esc2.VCC20, M8.i.variables.Esc2.VCC7)
...
df.MG2.i.variables <- data.frame( 'MG2', edad.int, MG2.i.variables.Esc1.VCC20, MG2.i.variables.Esc1.VCC7, MG2.i.variables.Esc2.VCC20, MG2.i.variables.Esc2.VCC7)
...
df.MG2rn.i.variables <- data.frame( 'MG2rn', edad.int, MG2rn.i.variables.Esc1.VCC20, MG2rn.i.variables.Esc1.VCC7, MG2rn.i.variables.Esc2.VCC20, MG2rn.i.variables.Esc2.VCC7)
...
```{r plotVACAR, fig.height=5, fig.width=15, fig.align='center', fig.cap="\\label{fig:plotVACAR}Volumen acumulado de madera aprovechada para cada escenarios de gestión"}
...
```{r plot.vol.aprov.cum.all x calidad, fig.height=5, fig.width=13, fig.align='center', fig.cap='Volumen acumulado de madera aprovechada para cada calidad de estación'}
...
```{r plot.vol.aprov.cum.gross x calidad, fig.height=5, fig.width=13, fig.align='center', fig.cap='Volumen acumulado de madera gruesa aprovechada por calidad de estación'}
...
```{r plot.vol.aprov.cum.thin x regimen, fig.height=5, fig.width=13, fig.align='center', fig.cap='Volumen acumulado de madera fina aprovechada por escenario de gestión'}
## gráficas volumen madera fina por calidades y escenarios de gestión
...
```{r plot.vol.aprov.cum.thin x calidad, fig.height=5, fig.width=13, fig.align='center', fig.cap='Volumen acumulado de madera fina aprovechada por calidad de estación'}
...
data.econ.long <- melt(data.econ, id=c( "Edad", "RegimenClara", "Zona", "Calidad", "N", "Vol.comercial20", "Vol.comercial7" ),
                       ...
                       measure.vars=c("renta.ant.act.Esc1.Int1", ## "renta.ant.act.Esc1.Int2",
                                      ...
                                      "renta.act.Esc1.Int3",
                                      "renta.ant.act.Esc2.Int1", ## "renta.ant.act.Esc2.Int2",
                                      "renta.ant.act.Esc2.Int3",
                                      "renta.act.Esc2.Int1", ## "renta.act.Esc2.Int2",
                                      "renta.act.Esc2.Int3") )  # convert to long format
...
data.econ.long[data.econ.long$variable=="renta.ant.act.Esc2.Int3",'variable'] <- "renta.act.Esc2.Int3"
...
```{r plot.rentab.cal7.1.2, fig.height=8, fig.width=16, fig.align='center', fig.cap='Renta actualizada para la Calidad de Estacion 7 m, escenario de precios 1, interés 2\\%'}
...
```{r plot.rentab.cal7.1.4, fig.height=8, fig.width=18, fig.align='center', fig.cap='Renta actualizada para la Calidad de Estacion 7 m, escenario de precios 1, interés 4\\%'}
...
```{r plot.rentab.cal7.2.2, fig.height=8, fig.width=18, fig.align='center', fig.cap='Renta actualizada para la Calidad de Estacion 7 m, escenario de precios 2, interés 2\\%'}
...
```{r plot.rentab.cal7.2.4, fig.height=8, fig.width=18, fig.align='center', fig.cap='Renta actualizada para la Calidad de Estacion 7 m, escenario de precios 2, interés 4\\%'}
ggplot(data = data.econ.long[data.econ.long$Calidad==7 & data.econ.long$variable=="renta.act.Esc2.Int3",],
       aes(x=Edad, y=Renta, colour = RegimenClara)) + ## ylim(-2700, 3600) +
    geom_line() + geom_point() + facet_grid( ( ~ Zona) ) +
    scale_colour_manual(values=palette) +
...
ggplot(data = data.econ.long[data.econ.long$Calidad==11 & data.econ.long$variable=="renta.act.Esc2.Int3",],
       aes(x=Edad, y=Renta, colour = RegimenClara)) + ## ylim(-2500, 13200)  +
    geom_line() + geom_point() + facet_grid( ( ~ Zona) ) +
    scale_colour_manual(values=palette) +
...
ggplot(data = data.econ.long[data.econ.long$Calidad==16 & data.econ.long$variable=="renta.act.Esc2.Int3",],
       aes(x=Edad, y=Renta, colour = RegimenClara)) + ## ylim(-2500, 32000)  +
    geom_line() + geom_point() + facet_grid( ( ~ Zona) ) +
    scale_colour_manual(values=palette) +
...
ggplot(data = data.econ.long[data.econ.long$Calidad==21 & data.econ.long$variable=="renta.act.Esc2.Int3",],
       aes(x=Edad, y=Renta, colour = RegimenClara)) + ## ylim(-2500, 60000)  +
    geom_line() + geom_point() + facet_grid( ( ~ Zona) ) +
    scale_colour_manual(values=palette) +
...
ggplot(data = data.econ.long[data.econ.long$Calidad==26 & data.econ.long$variable=="renta.act.Esc2.Int3",],
       aes(x=Edad, y=Renta, colour = RegimenClara)) + ## ylim(-2500, 91000) +
    geom_line() + geom_point() + facet_grid( ( ~ Zona) ) +
    scale_colour_manual(values=palette) +
