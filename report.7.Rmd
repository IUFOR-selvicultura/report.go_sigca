...
```{r plotVACAR, fig.pos = 'H', fig.height=5, fig.width=15, fig.align='center', fig.cap="\\label{fig:plotVACAR}Volumen acumulado de madera aprovechada para cada escenarios de gestión"}
...
Para poder hacer comparables de forma directa los escenarios debemos hacer una valoración que tiene en cuenta un escenario de infinitos ciclos con las mismas condiciones ecologicas y económicas. 
