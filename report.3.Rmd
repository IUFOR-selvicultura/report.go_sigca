...
Se muestra a continuación la distribución del volumen acumulado aprovechado de más de 7 cm en punta delgada, comparando los regimenes de clara para cada calidad de estación: 
...
Se muestra a continuación la distribución del volumen acumulado aprovechado de más de 20 cm en punta delgada, comparando los regimenes de clara para cada calidad de estación: 
...
Se muestra a continuación la distribución del volumen acumulado aprovechado entre 7 y 20 cm en punta delgada, comparando las calidades de estación para cada régimen de clara:
...
Se muestra a continuación la distribución del volumen acumulado aprovechado entre 7 y 20 cm en punta delgada, comparando los regimenes de clara para cada calidad de estación: 
...
En zonas con muy baja calidad de estación está totalmente desaconsejado el uso de *Pinus pinaster* en ninguno de los escenarios selvícolas estudiados, ya que ninguna de las intervenciones selvícolas permite la recuperación del capital, y ello solo es posible en la corta final en los escenarios M2, MG2
...
La siguiente conclusión es que el escenario selvícola MG2 es el mejor en todas las calidades y escenarios, salvo para calidad 7 m con un interés del 2%.

En buenas calidades parece que las previsiones de volumen aprovechable son muy buenas, quizá excesivas, sobre todo para el escenario M8 sin ninguna intervención selvícola. Esto puede hacer pensar que es necesaria una simulación más precisa, sobre todo en este escenario sin selvicultura en el que incluir el efecto de la mortalidad natural parece obligado.
